...
file_handler::file_handler(file_purpose _purpose, std::string _file_name, file_buffer_mode _buffer_mode, int _key_width):purpose_(_purpose),file_name_(_file_name),buffer_mode_(_buffer_mode),key_width_(_key_width),file_(),file_unavailable(false) {
