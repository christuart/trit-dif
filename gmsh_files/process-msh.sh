...
do
	...
	"\$Elements")
		...
		do
		    ...
		    if ! [[ "$type" =~ ^(1|2|3|4|5)$ ]] # ^(1|2|1)$ used here to demonstrate how multiple element types will be accommodated here, will be e.g. ^(1|2|5|17|16)$
		    then
