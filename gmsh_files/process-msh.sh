...
echo "***  for generating easy human and computer-readable"
echo "***  files from Gmsh outputs files."
echo "***"
echo "***  This version: 14/07/2016"
echo "***"
...
do
	...
	"\$Elements")
		...
		do
		    ...
		    #     (as of 04-07-2016)
		    if ! [[ "$type" =~ ^(1|1|1)$ ]] # ^(1|1|1)$ used here to demonstrate how multiple element types will be accommodated here, will be e.g. ^(1|2|5|17|16)$
		    then
